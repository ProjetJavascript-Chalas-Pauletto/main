class Game {
    ...
    updateActivity(ressourceId,mapType) {
        ...
        $('#mainActivity').append($("<button />").addClass("jobButton btn-lg").html(activityName).click(click_activity_farm));
        $('#mainActivity').append($("<button />").addClass("jobButton btn-lg").html(activityStore).click(click_activity_save));
    }
}